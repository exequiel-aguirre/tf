...
El estudio de los subgrupos discretos de un grupo de Lie aparece en àreas
...
explicitamente sus multiplicidades. ( Ver \cite{Fo} ,\cite{Th}).
...
Denotaremos como $\mathfrak{h}_n$ el álgebra de Lie, de $\mathbb{H}_n$.
Luego $\mathfrak{h}_n$ es $\mathbb{C}^n \times \mathbb{R}$  con el corchete de Lie dado por 
$$
[(v,t),(v',s)]=(0,\psi(v,v')).
$$
...
Describamos más en detalle el grupo de automorfismos $\mathbb{A}_n$ de $\mathfrak{h}_n$.
