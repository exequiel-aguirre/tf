...
\begin{definition}
 Recordemos que un automorfismo $\alpha: \mathbb{H}_n \mapsto \mathbb{H}_n$ es un isomorfismo lineal tal que 
 $$\begin{aligned}
...
dado que $A \in GL(2n,\mathbb{R})$,$\Phi$ es biyectiva y además,
$$\begin{aligned}
