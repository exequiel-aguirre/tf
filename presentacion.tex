...
\begin{lemma} \label{1.8}
 Un $D \in HL(\mathbb{C}^n)$ se puede escribir como una suma directa $\psi-ortogonal : D=<v_1,v_1'>\oplus<v_2,v_2'>\oplus...\oplus<v_n,v_n'>$
 de $\mathbb{Z}$-módulos bidimensionales $<v_j,v_j'>$. Sea $r_j=\psi(v_j,v_j')$. Entonces la descomposición puede ser tomada 
 de forma tal que $r_j \in \mathbb{R}^{>0}$ y $\frac{r_{j+1}}{r_j}  \in \mathbb{Z}$.
 
 Es más, estos $r_j$ están unívocamente determinados por D.
\end{lemma}
...
\begin{frame}
 ...
 Sea $e_j$, $1\leq j \leq 2n $,  la base canónica de $\mathbb{R}^{2n}$.
